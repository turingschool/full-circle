class Defaults
  ...
  class << self
    ...
    def guidelines(cohort)
      ...
      <p>At Turing School, we want to do what we can to address whatever is holding you
      ...
      program to include all underrepresented groups.</p>
      <p>We have two scholarships available at $4,000/each for every cohort for each program.
      If you belong to any group that is underrepresented in technology and you have been
      ...
      <p>1. In 200-300 words, please tell us the story of how you became interested in a
      career in software development.</p>
      <p>2. In 200-300 words, please share something you would be passionate about
      contributing to the world in the next five years.</p>
      <p>3. In 200-300 words, please share a challenge/situation you have experienced that
      you believe was based on your status as a person in an underrepresented group
      and how you overcame that challenge or handled that situation.</p>
      <p>4. In 200-300 words, please describe your financial barriers and how participation in
      this scholarship program could impact your ability to pursue education at Turing
      and a career in software development.</p>
      <h3>Formatting:</h3>
      ...
      <p>Turing scholarships will be awarded by a diverse panel drawn from: Turing staff and
      ...
      scholarships, or discounts.</p>
      <p>2. By applying for admission to Turing and the Scholarship program, you certify that
      ...
      considered.</p>
      <p>3. Scholarships are subject to the availability of funds and based on satisfaction of
      all terms and conditions.</p>
      <p>4. By participating in the scholarship program, you authorize Turing School to
      ...
      <p>5. Scholarship may be withdrawn if candidate is awarded a scholarship and fails to
      sign the enrollment contract and pay the $1,000 deposit required of all students.</p>
      <p>6. Scholarship may be withdrawn if the candidate withdraws from Turing.</p>
      <p>7. Scholarship may be withdrawn if the candidate violates Turing’s Student Conduct
      Policy.</p>
      <p>8. Students are responsible for cost of living and relocation.</p>"
    end
  end
end